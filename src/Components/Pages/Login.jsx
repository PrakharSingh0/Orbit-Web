  ...
  return (
    ...
    >
      ...
      <div className="relative w-full max-w-md p-8 rounded-2xl backdrop-blur-xl bg-black/20 shadow-[0_0_40px_rgba(8,_112,_184,_0.7)] border border-white/10">
        <h2 className="text-4xl font-bold text-center mb-8 text-white bg-clip-text">Login to Orbit</h2>
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-white/60">
            ...
            <Link to="/signup" className="text-indigo-400 hover:text-indigo-300 transition-colors duration-300">
              Sign up
            </Link>
          </p>
        </div>
