...
const RightSide = () => {
  ...
  return (
    <div className="flex flex-col h-screen bg-[#0f172a] text-white shadow-lg border-2 border-[#99f6e4] rounded-l-xl">
      <div className="flex flex-col items-center relative pt-10">
        <img className="h-48 rounded-md" src={waterslide} alt="nature"></img>
      </div>
      <p className="font-roboto font-normal text-sm  max-w-fit no-underline tracking-normal leading-tight py-2 mx-2">
      ...
      <div className="mx-2 mt-10">
        <p className="font-roboto font-medium text-sm  no-underline tracking-normal leading-none">
          Friends:{" "}
        </p>
        <input
        ...
        {friendList?.length > 0 ? (
                  ...
                  <div className="flex items-center my-2 cursor-pointer">
                    <div className="flex items-center">
                      <Avatar
                        ...
                        alt="avatar"
                      ></Avatar>
                      <p className="ml-4 font-roboto font-medium text-sm  no-underline tracking-normal leading-none">
                        {friend.name}
                      </p>
                    </div>
                  </div>
          ...
          <p className="mt-10 font-roboto font-medium text-sm  no-underline tracking-normal leading-none">
